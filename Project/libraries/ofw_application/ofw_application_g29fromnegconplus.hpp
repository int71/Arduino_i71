...
namespace ofw{
	...
	namespace application{
		...
		typedef const G29FROMNEGCONPLUS	CG29FROMNEGCONPLUS;
		typedef G29FROMNEGCONPLUS*	LPG29FROMNEGCONPLUS;
		typedef CG29FROMNEGCONPLUS*	LPCG29FROMNEGCONPLUS;
		...
		public:
			...
			static CDWORD			stcdwnSteeringMargin=0x200;
			static CDWORD			stcdwnAccelMargin=0x300;
			static CDWORD			stcdwnAccelMultiply=320;
			static CDWORD			stcdwnBrakeMargin=0x300;
			static CDWORD			stcdwnBrakeMultiply=320;
			static CDWORD			stcdwnClutchMargin=0x300;
