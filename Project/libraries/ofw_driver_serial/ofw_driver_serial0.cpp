...
**									ofw										**
**																			**
**	driver/serial0									2024 written by int71	**
 ****************************************************************************/
...
VOID					SERIAL0::stDelete(VOID){
	return;
}

VOID					SERIAL0::stReset(VOID){
	st.biReadDone=0;
	st.biReadCurrent=0;
	return;
}

BYTE					SERIAL0::stbRead(VOID){
	BYTE					breturn;
...
VOID					SERIAL0::stPrintClear(VOID){
	stPrint(ARGSTR("\x1b[2J"));
	stPrintSetPosition(0,0);
	return;	
}

VOID					SERIAL0::stPrintSetPosition(
	BYTE					bix,
	BYTE					biy
){
	stPrint(ARGSTR("\x1b["));
...
VOID					SERIAL0::stPrintSetForeColor(
	BYTE					bccolor
){
...
VOID					SERIAL0::stPrintSetBackColor(
	BYTE					bccolor
){
